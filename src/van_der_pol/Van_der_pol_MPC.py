...
class VanDerPolMPC:
    """
    This class implements the VDP MPC in acados. 
    Settings can be adjusted in the VanDerPolMPCOptions object that is passed during instantiation of VanDerPolMPC.
